...
void t_matrix_dbout1(double *x, double *y, double *P, double *H, double *R, int n, int m)
{
...
void t_matrix_dbout2(double *x, double *P, int n)
{
    printf("xu=[\n"); matprint(x,n,1,8,4); printf("];\n");
    printf("Pu=[\n"); matprint(P,n,n,8,4); printf("];\n");
